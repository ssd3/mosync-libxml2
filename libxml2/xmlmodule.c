...
static void xmlModuleErrMemory(xmlModulePtr module, const char *extra) {
	...
	__xmlRaiseError(NULL, NULL, NULL, NULL, NULL, XML_FROM_MODULE,
			XML_ERR_NO_MEMORY, XML_ERR_FATAL, NULL, 0, extra, name, NULL, 0, 0,
...
//		xmlFree(module);
//		__xmlRaiseError(NULL, NULL, NULL, NULL, NULL, XML_FROM_MODULE,
//				XML_MODULE_OPEN, XML_ERR_FATAL, NULL, 0, 0, name, NULL, 0, 0,
//				"failed to open %s\n", name);
//		return (NULL);
//	}
//
...
//		__xmlRaiseError(NULL, NULL, NULL, NULL, NULL, XML_FROM_MODULE,
//				XML_MODULE_OPEN, XML_ERR_FATAL, NULL, 0, 0, NULL, NULL, 0, 0,
//				"null parameter\n");
//		return rc;
//	}
//
...
//	if (NULL == module) {
//		__xmlRaiseError(NULL, NULL, NULL, NULL, NULL, XML_FROM_MODULE,
//				XML_MODULE_CLOSE, XML_ERR_FATAL, NULL, 0, 0, NULL, NULL, 0, 0,
//				"null module pointer\n");
//		return -1;
//	}
//
...
int xmlModuleFree(xmlModulePtr module) {
	if (NULL == module) {
		__xmlRaiseError(NULL, NULL, NULL, NULL, NULL, XML_FROM_MODULE,
				XML_MODULE_CLOSE, XML_ERR_FATAL, NULL, 0, NULL, NULL, NULL, 0,
